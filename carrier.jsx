...
// function EventDetailsriser({ selectedEvent }) {
//   if (!selectedEvent) {
...
//       <p>Event Code: {selectedEvent.event_code}</p>
//       <p>Start Date: {selectedEvent.start_at}</p>
//       <p>End Date: {selectedEvent.end_at}</p>
...
const EventDetailsriser = ({ selectedEvent }) => {
...
// {Event: '#bbcbf2', Venue: '#bbcbf2', Venue Requirements: '#bbcbf2', Participants: '#bbcbf2', Guest: '#bbcbf2', …}
// Accomodation
// :
// "#bbcbf2"
// Event
